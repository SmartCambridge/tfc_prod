...
function RTMonitorAPI(client_data) {
    ...
    this.RTMONITOR_URI = 'https://tfc-app2.cl.cam.ac.uk/test/rtmonitor/sirivm';

    var self = this;

    this.VERSION = '2.1_lobby_screen_test';
    ...
    console.log('RTMonitorAPI V'+this.VERSION+' instantiation',self.client_data);
...
{
    console.log('RTMonitorAPI',str); return;
